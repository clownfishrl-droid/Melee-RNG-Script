...
local DungeonTab = Win:Tab("🏯", "Dungeon")
...
-- Dungeon tools live in their own left-side tab now instead of being mixed into Misc.
meleeGuiMountDungeonTpSection(DungeonTab, SLbl, C)
meleeGuiMountClientRoomSection(DungeonTab, SLbl, C)
