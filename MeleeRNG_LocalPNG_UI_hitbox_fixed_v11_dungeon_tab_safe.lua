...
-- Keep DungeonTab out of this giant UI scope's long-lived locals. The script is close
-- to Luau's local/register limit; one extra live tab local can stop the UI from compiling.
_G.MeleeRNG_DungeonTab = Win:Tab("🏯", "Dungeon")
meleeGuiMountDungeonTpSection(_G.MeleeRNG_DungeonTab, SLbl, C)
meleeGuiMountClientRoomSection(_G.MeleeRNG_DungeonTab, SLbl, C)
