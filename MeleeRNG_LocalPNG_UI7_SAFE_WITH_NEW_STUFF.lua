...
function meleeMountSafeDungeonMobTimeTrialAddons(MiscTab, SLbl, C)
    ...
    MiscTab:Button("▶️", "Start Time Trial once", "Calls the existing StartTimeTrial remote once.", C.green, function()
        local ok = fireR("StartTimeTrial")
        safeSet(ttLabel, ok and "StartTimeTrial fired" or "StartTimeTrial remote missing/failed")
    end)
