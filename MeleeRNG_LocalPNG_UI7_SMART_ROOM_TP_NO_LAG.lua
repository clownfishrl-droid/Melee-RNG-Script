...
function meleeMountSafeDungeonMobTimeTrialAddons(MiscTab, SLbl, C)
    ...
    local MOB_QUEUE_BATCH = 18      -- visual-hide batch only; mob movement is immediate
    local MOB_DESC_BUDGET = 20      -- yield every N descendants while hiding a large mob
    local MOB_BACKUP_SWEEP_SEC = 3.0
